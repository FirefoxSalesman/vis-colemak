...
static const KeyBinding bindings_motions[] = {
	...
	{ "J",                  ACTION(CURSOR_LONGWORD_END_NEXT)            },
	{ "j",                  ACTION(CURSOR_WORD_END_NEXT)                },
	{ "F",                  ACTION(TO_LINE_LEFT)                        },
	{ "f",                  ACTION(TO_LINE_RIGHT)                       },
	{ "go",                 ACTION(CURSOR_BYTE)                         },
	{ "gH",                 ACTION(CURSOR_BYTE_LEFT)                    },
	{ "gI",                 ACTION(CURSOR_BYTE_RIGHT)                   },
	{ "gh",                 ACTION(CURSOR_CODEPOINT_PREV)               },
	{ "gi",                 ACTION(CURSOR_CODEPOINT_NEXT)               },
	{ "g0",                 ACTION(CURSOR_SCREEN_LINE_BEGIN)            },
	{ "g_",                 ACTION(CURSOR_LINE_FINISH)                  },
	{ "G",                  ACTION(CURSOR_LINE_LAST)                    },
	{ "g$",                 ACTION(CURSOR_SCREEN_LINE_END)              },
	{ "gJ",                 ACTION(CURSOR_LONGWORD_END_PREV)            },
	{ "gj",                 ACTION(CURSOR_WORD_END_PREV)                },
	{ "gg",                 ACTION(CURSOR_LINE_FIRST)                   },
	{ "gn",                 ACTION(CURSOR_SCREEN_LINE_DOWN)             },
	{ "ge",                 ACTION(CURSOR_SCREEN_LINE_UP)               },
	{ "gm",                 ACTION(CURSOR_SCREEN_LINE_MIDDLE)           },
	{ "h",                  ACTION(CURSOR_CHAR_PREV)                    },
	{ "H",                  ACTION(CURSOR_WINDOW_LINE_TOP)              },
	{ "n",                  ACTION(CURSOR_LINE_DOWN)                    },
	{ "e",                  ACTION(CURSOR_LINE_UP)                      },
	{ "i",                  ACTION(CURSOR_CHAR_NEXT)                    },
	{ "I",                  ACTION(CURSOR_WINDOW_LINE_BOTTOM)           },
	{ "M",                  ACTION(CURSOR_WINDOW_LINE_MIDDLE)           },
	{ "k",                  ACTION(CURSOR_SEARCH_REPEAT_FORWARD)        },
	{ "K",                  ACTION(CURSOR_SEARCH_REPEAT_BACKWARD)       },
...
static const KeyBinding bindings_textobjects[] = {
	...
	{ "ab",                 ALIAS("a(")                                 },
	{ "aB",                 ALIAS("a{")                                 },
	{ "ai",                 ACTION(TEXT_OBJECT_LINE_OUTER)              },
	...
	{ "gK",                 ACTION(TEXT_OBJECT_SEARCH_BACKWARD)         },
	{ "gk",                 ACTION(TEXT_OBJECT_SEARCH_FORWARD)          },
	{ "l<",                 ACTION(TEXT_OBJECT_ANGLE_BRACKET_INNER)     },
	{ "l`",                 ACTION(TEXT_OBJECT_BACKTICK_INNER)          },
	{ "l{",                 ACTION(TEXT_OBJECT_CURLY_BRACKET_INNER)     },
	{ "l(",                 ACTION(TEXT_OBJECT_PARENTHESIS_INNER)       },
	{ "l\"",                ACTION(TEXT_OBJECT_QUOTE_INNER)             },
	{ "l\'",                ACTION(TEXT_OBJECT_SINGLE_QUOTE_INNER)      },
	{ "l[",                 ACTION(TEXT_OBJECT_SQUARE_BRACKET_INNER)    },
	{ "l>",                 ALIAS("i<")                                 },
	{ "l)",                 ALIAS("i(")                                 },
	{ "l]",                 ALIAS("i[")                                 },
	{ "l}",                 ALIAS("i{")                                 },
	{ "lb",                 ALIAS("i(")                                 },
	{ "lB",                 ALIAS("i{")                                 },
	{ "li",                 ACTION(TEXT_OBJECT_LINE_INNER)              },
	{ "lp",                 ACTION(TEXT_OBJECT_PARAGRAPH)               },
	{ "ls",                 ACTION(TEXT_OBJECT_SENTENCE)                },
	{ "l<Tab>",             ACTION(TEXT_OBJECT_INDENTATION)             },
	{ "lW",                 ACTION(TEXT_OBJECT_LONGWORD_INNER)          },
	{ "lw",                 ACTION(TEXT_OBJECT_WORD_INNER)              },
	{ 0 /* empty last element, array terminator */                      },
};
...
static const KeyBinding bindings_normal[] = {
	...
	{ "<C-j>",              ACTION(WINDOW_SLIDE_UP)                     },
	{ "<C-f>",              ALIAS("<PageDown>")                         },
	{ "<C-n>",              ACTION(SELECTIONS_NEW_LINE_BELOW)           },
	{ "<C-e>",              ACTION(SELECTIONS_NEW_LINE_ABOVE)           },
	{ "<C-i>",              ACTION(SELECTIONS_REMOVE_COLUMN_EXCEPT)     },
	{ "<C-k>",              ALIAS("viw")                                },
	...
	{ "<C-w>c",             ALIAS(":q<Enter>")                          },
	{ "<C-w>h",             ALIAS("<C-w>k")                             },
	{ "<C-w>n",             ACTION(WINDOW_NEXT)                         },
	{ "<C-w>e",             ACTION(WINDOW_PREV)                         },
	{ "<C-w>i",             ALIAS("<C-w>j")                             },
	{ "<C-w>k",             ALIAS(":open<Enter>")                       },
	...
	{ "gK",                 ALIAS("vgN")                                },
	{ "gv",                 ALIAS("v'^M")                               },
	{ "L",                  ACTION(INSERT_LINE_START)                   },
	{ "l",                  ACTION(MODE_INSERT)                         },
	{ "N",                  ACTION(JOIN_LINES)                          },
	{ "gN",                 ACTION(JOIN_LINES_TRIM)                     },
	{ "<M-C-n>",            ACTION(SELECTIONS_NEW_LINE_BELOW_LAST)      },
	{ "<M-C-e>",            ACTION(SELECTIONS_NEW_LINE_ABOVE_FIRST)     },
...
static const KeyBinding bindings_visual[] = {
	...
	{ "<C-e>",              ALIAS("<C-u>")                              },
	{ "<C-i>",              ACTION(SELECTIONS_REMOVE_COLUMN_EXCEPT)     },
	{ "<C-k>",              ACTION(SELECTIONS_NEW_MATCH_NEXT)           },
	{ "<C-p>",              ACTION(SELECTIONS_REMOVE_LAST)              },
	{ "<C-u>",              ACTION(SELECTIONS_PREV)                     },
	{ "<C-x>",              ACTION(SELECTIONS_NEW_MATCH_SKIP)           },
	{ "<Escape>",           ACTION(MODE_VISUAL_ESCAPE)                  },
	{ "L",                  ACTION(SELECTIONS_NEW_LINES_BEGIN)          },
	{ "N",                  ACTION(JOIN_LINES)                          },
	{ "gN",                 ACTION(JOIN_LINES_TRIM)                     },
